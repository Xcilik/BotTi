...
const expiredCheck = (farid, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            farid.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              farid.groupLeave(_dir[position].id)
